...
"[project]/src/lib/store-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/tourist-place-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/search-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/store-data.ts [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tourist$2d$place$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/tourist-place-data.ts [app-ssr] (ecmascript)");
...
/** Build a flat, searchable list from all data sources. */ function buildSearchIndex() {
    ...
    for (const b of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$business$2d$listing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["businesses"]){
        items.push({
            id: b.id,
            type: "business",
            label: b.name,
    ...
    const businessStoreIds = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$business$2d$listing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["businesses"].map((b)=>b.storeId));
    for (const [id, store] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storeDatabase"])){
    ...
    for (const [id, p] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["productDatabase"])){
        items.push({
            id: `prod-${id}`,
            type: "product",
            label: p.name,
    ...
    for (const sc of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$service$2d$category$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serviceCategories"]){
        items.push({
            id: `svc-${sc.slug}`,
            type: "service",
            label: sc.label,
    ...
    for (const cl of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$category$2d$landing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categoryLandingData"]){
        items.push({
            id: `cat-${cl.slug}`,
            type: "category",
            label: cl.label,
    ...
    for (const ec of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$business$2d$listing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["extendedCategories"]){
        const exists = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$category$2d$landing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categoryLandingData"].some((cl)=>cl.slug === ec.slug);
        if (!exists) {
            const count = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$business$2d$listing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBusinessesByCategory"])(ec.slug).length;
            items.push({
                id: `catl-${ec.slug}`,
                type: "category",
                label: ec.label,
    ...
    // 7) Tourist places
    for (const tp of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tourist$2d$place$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touristPlaces"]){
        items.push({
            id: `tp-${tp.slug}`,
            type: "tourist_place",
            label: tp.name,
...
function searchAll(query, location, limit = 6) {
    ...
    const scored = searchIndex.map((item)=>{
        ...
        if (item.type === "business") {
            const biz = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$business$2d$listing$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["businesses"].find((b)=>b.id === item.id);
...
//# sourceMappingURL=src_lib_a56e864a._.js.map