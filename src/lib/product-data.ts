...
export const productDatabase: Record<string, ProductDetail> = {
  ...
  "cp-p1": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Dabur" },
      { label: "Type", value: "Ayurvedic Supplement" },
  ...
  "cp-p2": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Volini (Sun Pharma)" },
      { label: "Active Ingredient", value: "Diclofenac Diethylamine" },
      { label: "Usage", value: "External use only" }
    ],
    deliveryEstimate: "1-2 days",
  ...
  "cp-p3": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Ensure (Abbott)" },
      { label: "Flavor", value: "Vanilla" },
      { label: "Servings", value: "Approx 10" }
    ],
  ...
  "cp-p4": {
    ...
    specifications: [
      { label: "Brand", value: "Accu-Chek (Roche)" },
      { label: "Test Time", value: "4 seconds" },
      { label: "Sample", value: "0.6 µL blood" },
  ...
  "cp-p5": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Dettol (Reckitt)" },
      { label: "Active Ingredient", value: "Chloroxylenol 4.8%" },
  ...
  "fm-p2": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Fortune (Adani Wilmar)" },
  ...
  "fm-p3": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Aashirvaad (ITC)" },
  ...
  "fm-p4": {
    ...
    specifications: [
      ...
      { label: "Type", value: "Pasteurized Butter" },
      { label: "Shelf Life", value: "9 months (refrigerated)" }
    ],
    deliveryEstimate: "Same day",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "fm-p5": {
    ...
    specifications: [
      { label: "Weight", value: "5kg" },
      { label: "Brand", value: "Premium Select" },
      { label: "Type", value: "Aged Basmati Rice" },
  ...
  "fm-p6": {
    ...
    specifications: [
      { label: "Quantity", value: "Pack of 12 (12 × 70g)" },
      { label: "Brand", value: "Maggi (Nestlé)" },
      { label: "Type", value: "Instant Noodles" },
      { label: "Shelf Life", value: "6 months" }
    ],
    deliveryEstimate: "Same day",
    returnPolicy: "7 days replacement",
  ...
  "qe-p1": {
    ...
    specifications: [
      ...
      { label: "Compatibility", value: "Universal (trim to fit)" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "qe-p3": {
    ...
    specifications: [
      { label: "Battery", value: "24hr total (5hr + 19hr case)" },
  ...
  "qe-p4": {
    ...
    specifications: [
      ...
      { label: "Output", value: "Dual USB (18W max)" },
  ...
  "gl-p1": {
    ...
    specifications: [
      ...
      { label: "Type", value: "Organic Green Tea" },
      { label: "Origin", value: "Darjeeling, India" },
      { label: "Caffeine", value: "Low (25mg per cup)" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "gl-p2": {
    ...
    specifications: [
      { label: "Quantity", value: "6 bottles (250ml each)" },
      { label: "Flavors", value: "Orange, Apple, Berry, Green, Watermelon, Carrot" },
      { label: "Storage", value: "Refrigerate, consume within 3 days" },
  ...
  "gl-p3": {
    ...
    specifications: [
      { label: "Weight", value: "500g" },
      { label: "Type", value: "Granola with Mixed Berries" },
      { label: "Dietary", value: "Vegetarian, High Fiber" },
  ...
  "gl-p4": {
    ...
    specifications: [
      ...
      { label: "Material", value: "Bamboo Fiber + Silicone Lid" },
  ...
  "vs-p1": {
    ...
    specifications: [
      ...
      { label: "Battery", value: "6hr + 24hr case (ANC on)" },
  ...
  "vs-p3": {
    ...
    specifications: [
      ...
      { label: "Display", value: "1.62\" AMOLED (490 nits)" },
      { label: "Battery", value: "16 days" },
  ...
  "vs-p5": {
    ...
    specifications: [
      ...
      { label: "Speed", value: "130MB/s read, U3 Class 10" },
      { label: "Durability", value: "Water, Temp, X-ray, Magnet proof" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement",
  ...
  "vs-p6": {
    ...
    specifications: [
      ...
      { label: "Output", value: "65W (5V/3A, 11V/5A, 20V/3.25A)" },
      { label: "Connector", value: "USB-C" },
      { label: "Safety", value: "Over-voltage, over-current protection" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement",
    warranty: "6 months warranty"
  ...
  "tf-p1": {
    ...
    specifications: [
      { label: "Battery", value: "6hr + 24hr case" },
  ...
  "tf-p2": {
    ...
    specifications: [
      ...
      { label: "Features", value: "Kickstand, Camera Guard" },
      { label: "Compatibility", value: "Universal (trim to fit)" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
  ...
  "tf-p3": {
    ...
    specifications: [
      ...
      { label: "Safety", value: "Over-current, over-voltage, short-circuit" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
  ...
  "tf-p4": {
    ...
    specifications: [
      { label: "Switches", value: "Blue (Hot-swappable)" },
  ...
  "sf-p1": {
    ...
    specifications: [
      { label: "Quantity", value: "Pack of 20 sachets" },
      { label: "Type", value: "Masala Chai Premix" },
      { label: "Preparation", value: "Add 150ml hot water" },
      { label: "Shelf Life", value: "12 months" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
  ...
  "sf-p2": {
    ...
    specifications: [
      { label: "Weight", value: "200g" },
      { label: "Type", value: "Spice Blend" },
      { label: "Ingredients", value: "12 whole spices" },
      { label: "Shelf Life", value: "9 months" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
  ...
  "sf-p3": {
    ...
    specifications: [
      { label: "Volume", value: "1L" },
      { label: "Type", value: "Mango Lassi Concentrate" },
      { label: "Yield", value: "~4 liters when mixed" },
  ...
  "sf-p4": {
    ...
    specifications: [
      { label: "Quantity", value: "Pack of 5 sets" },
      { label: "Type", value: "Frozen Prepared Meal" },
      { label: "Prep Time", value: "10 minutes" },
      { label: "Storage", value: "Keep frozen (-18°C)" }
    ],
  ...
  "ls-p1": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "L'Oreal Professionnel" },
  ...
  "ls-p2": {
    ...
    specifications: [
      { label: "Brand", value: "Schwarzkopf" },
      { label: "Type", value: "Ammonia-Free Hair Color" },
      { label: "Duration", value: "Up to 6 weeks" },
      { label: "Contents", value: "Color tube + Developer + Gloves" }
    ],
    deliveryEstimate: "3-5 days",
  ...
  "ls-p3": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Kérastase (L'Oreal)" },
      { label: "Key Ingredients", value: "Camelina Oil, Vitamin E" },
      { label: "Hair Type", value: "Frizz-prone, all types" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement (unopened only)",
    warranty: "No warranty"
  ...
  "sh-p1": {
    ...
    specifications: [
      { label: "Volume", value: "340ml" },
      { label: "Brand", value: "Biolage (Matrix)" },
      { label: "Key Ingredients", value: "Camellia Oil, Aloe Vera" },
      { label: "Hair Type", value: "Frizzy, unruly hair" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "sh-p2": {
    ...
    specifications: [
      { label: "Volume", value: "85ml" },
      { label: "Brand", value: "Wella Professionals" },
      { label: "Type", value: "Liquid Hair Toner" },
      { label: "Use", value: "Mix with Wella Developer (1:2 ratio)" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement (unopened only)",
    warranty: "No warranty"
  ...
  "fb-p1": {
    ...
    specifications: [
      { label: "Weight", value: "200g" },
      { label: "Type", value: "Biryani Spice Blend" },
      { label: "Ingredients", value: "15 spices + saffron" },
      { label: "Yield", value: "Enough for ~3kg rice biryani" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "fb-p2": {
    ...
    specifications: [
      { label: "Weight", value: "500g" },
      { label: "Type", value: "Raw Mango Pickle (Aam Ka Achar)" },
      { label: "Aging", value: "3 months" },
      { label: "Shelf Life", value: "12 months" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
  ...
  "fb-p3": {
    ...
    specifications: [
      { label: "Quantity", value: "Pack of 10 parathas" },
      { label: "Type", value: "Frozen Whole Wheat Paratha" },
      { label: "Prep Time", value: "2 minutes on tawa" },
      { label: "Storage", value: "Keep frozen (-18°C)" }
    ],
    deliveryEstimate: "Same day (frozen delivery)",
    returnPolicy: "No returns (frozen food)",
  ...
  "fz-p1": {
    ...
    specifications: [
      ...
      { label: "Servings", value: "Approx 33" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement (unopened only)",
    warranty: "No warranty"
  ...
  "fz-p2": {
    ...
    specifications: [
      { label: "Quantity", value: "5 bands + accessories" },
      { label: "Resistance Levels", value: "5 (10lb - 50lb)" },
      { label: "Material", value: "Natural Latex" },
      { label: "Accessories", value: "Door anchor, carry bag, ankle straps" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement",
    warranty: "6 months warranty"
  ...
  "fz-p3": {
    ...
    specifications: [
      { label: "Material", value: "Breathable Mesh + Silicone" },
      { label: "Closure", value: "Velcro wrist wrap" },
      { label: "Grip", value: "Anti-slip silicone palm" },
  ...
  "fz-p4": {
    ...
    specifications: [
      { label: "Weight", value: "500g" },
      { label: "BCAA Ratio", value: "2:1:1 (L-Leucine, L-Isoleucine, L-Valine)" },
  ...
  "fp-p1": {
    ...
    specifications: [
      ...
      { label: "Type", value: "Creatine Monohydrate (Micronized)" },
      { label: "Flavor", value: "Unflavored" },
      { label: "Servings", value: "50 (5g per serving)" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement (unopened only)",
    warranty: "No warranty"
  ...
  "fp-p2": {
    ...
    specifications: [
      { label: "Dimensions", value: "183cm × 61cm × 6mm" },
      { label: "Material", value: "TPE (Thermoplastic Elastomer)" },
      { label: "Weight", value: "800g" },
      { label: "Accessories", value: "Carry strap included" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement",
    warranty: "6 months warranty"
  ...
  "fp-p3": {
    ...
    specifications: [
      { label: "Weight", value: "500g" },
      { label: "Caffeine", value: "200mg per serving" },
      { label: "Flavor", value: "Fruit Punch" },
  ...
  "sd-p1": {
    ...
    specifications: [
      { label: "Brand", value: "Oral-B (P&G)" },
      { label: "Bristle", value: "Soft" },
      { label: "Features", value: "Crisscross bristles, tongue cleaner" },
      { label: "Replacement", value: "Every 3 months" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "sd-p2": {
    ...
    specifications: [
      ...
      { label: "Brand", value: "Sensodyne (GSK)" },
      { label: "Type", value: "Sensitivity Repair Toothpaste" },
  ...
  "sd-p3": {
    ...
    specifications: [
      { label: "Quantity", value: "90 picks" },
      { label: "Flavor", value: "Mint" },
      { label: "Features", value: "Tongue cleaner, easy-grip handle" },
      { label: "Duration", value: "Approx 3 months supply" }
    ],
    deliveryEstimate: "2-3 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "sc-p1": {
    ...
    specifications: [
      { label: "Weight", value: "200g" },
      { label: "Brand", value: "Colgate (P&G)" },
      { label: "Type", value: "Complete Care Toothpaste" },
      { label: "Benefits", value: "12-in-1 protection" }
    ],
    deliveryEstimate: "1-2 days",
    returnPolicy: "7 days replacement",
    warranty: "No warranty"
  ...
  "sc-p2": {
    ...
    specifications: [
      ...
      { label: "Pressure Settings", value: "10 levels" },
      { label: "Water Capacity", value: "600ml" },
      { label: "Tips Included", value: "7 interchangeable tips" }
    ],
    deliveryEstimate: "3-5 days",
    returnPolicy: "7 days replacement for defective units",
  ...
  "sc-p3": {
    ...
    specifications: [
      { label: "Quantity", value: "14 strips (7 upper + 7 lower)" },
      { label: "Treatment Duration", value: "14 days" },
      { label: "Wear Time", value: "30 minutes per day" },
  ...
  "gb-p2": {
    ...
    specifications: [
      ...
      { label: "Key Ingredients", value: "Vitamin E, Jojoba Oil" },
  ...
  "gb-p3": {
    ...
    specifications: [
      { label: "Quantity", value: "5 sheet masks" },
      { label: "Types", value: "Hydrating, Brightening, Anti-aging, Pore Minimizing, Soothing" },
      { label: "Usage", value: "15-20 minutes per mask" },
...
export function getTrendingProducts(): ProductDetail[] {
  return [
    productDatabase["cp-p1"],   // Dabur Chyawanprash
    productDatabase["fm-p4"],   // Amul Butter
    productDatabase["fm-p3"],   // Aashirvaad Atta
    productDatabase["fm-p6"],   // Maggi Noodles
    productDatabase["qe-p4"],   // Power Bank
    productDatabase["qe-p2"],   // USB-C Cable
    productDatabase["vs-p2"],   // boAt Headphone
    productDatabase["vs-p1"],   // Samsung Galaxy Buds FE
    productDatabase["tf-p3"],   // 65W GaN Charger
    productDatabase["sf-p2"],   // Pav Bhaji Masala
    productDatabase["ls-p1"],   // L'Oreal Shampoo
    productDatabase["fz-p1"],   // Whey Protein
  ];
}